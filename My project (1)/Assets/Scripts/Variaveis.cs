...
public static class Variaveis 
{
    ...
    public static float distancia_inimigos = 20;
    public static float dano_inimigo = 5;
    public static float xp_inimigo = 5;
    public static float vida_max_inimigo = 20;
    public static float velocidade_inimigo = 1;
